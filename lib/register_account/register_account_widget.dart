...
class _RegisterAccountWidgetState extends State<RegisterAccountWidget> {
  ...
  void register(String username, phone, email, password) async {
    try {
      ...
      if (response.statusCode == 200) {
        ...
        Navigator.push(
          context,
          MaterialPageRoute(builder: (context) => HomePageAlt1Widget()),
        );
      } else {
        print('failed');
      }
