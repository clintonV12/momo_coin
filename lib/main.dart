...
class _MyAppState extends State<MyApp> {
  ...
  late Stream<MomoCoinFirebaseUser> userStream;
  MomoCoinFirebaseUser? initialUser;
  ...
  void initState() {
    super.initState();
    userStream = momoCoinFirebaseUserStream()
...
class _NavBarPageState extends State<NavBarPage> {
  ...
  Widget build(BuildContext context) {
    final tabs = {
      'MY_HomePage': HomePageAlt1Widget(), //HomePageWidget(),
